...
use crate::modules::auth::models::{
    CreatedUserDTO, LoginParams, LoginResponse, NewUserParams, UserInfo, VerifyToken,
};
use crate::modules::auth::session::{generate_session_token, get_ip_addr, get_user_agent};
use crate::modules::auth::totp::{generate_email_code, set_app_only_expire_time};
...
pub(crate) async fn create_user_and_try_save(
    req: &HttpRequest,
    user_id: &String,
